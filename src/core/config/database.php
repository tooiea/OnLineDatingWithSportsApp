    ...
    */
    ...
    'connections' => [
        ...
        't_baseball' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_BB', 'db_baseball'),
            'port' => env('DB_PORT_BB', '3306'),
            'database' => env('DB_DATABASE_BB', 't_baseball'),
            'username' => env('DB_USERNAME_BB', 'root'),
            'password' => env('DB_PASSWORD_BB', 'root'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
