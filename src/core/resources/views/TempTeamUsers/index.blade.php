...
<body>
    <div class="container w-50">
        <form action="{{ route('tmp_team_user.confirm') }}" method="post" enctype="multipart/form-data">
            @csrf
            <h4 class="pb-3">チーム登録</h4>
            <div class="container mb-5">
                <div class="form-group row d-flex justify-content-around">
                    <label for="sportAffiliationType" class="col-sm-3 col-form-label">スポーツ種別</label>
                    <div class="col-sm-7">
                        ...
                        @error('sportAffiliationType')<div class="invalid-feedback" role="alert"> {{ $message }}</div>
                        @enderror
                    </div>
                </div>
                <div class="form-group row d-flex justify-content-around">
                    <label for="teamName" class="col-sm-3 col-form-label">チーム名</label>
                    <div class="col-sm-7">
                        <input type="text" name="teamName" value="{{ old('teamName') }}" id="teamName"
                            aria-describedby="teamNameHelp" class="form-control @error('teamName') is-invalid @enderror"
                            placeholder="例：チーム名">
                ...
                <div class="form-group row d-flex justify-content-around">
                    <label for="teamLogo" class="col-sm-3 col-form-label">チームロゴ画像</label>
                    <div class="col-sm-7">
                        ...
                        <small id="teamLogoHelp" class="form-text text-muted">jpg,png形式</small>
                        @error('teamLogo')<div class="invalid-feedback" role="alert"> {{ $message }} </div>@enderror
                    </div>
                </div>
                <div class="form-group row d-flex justify-content-around">
                    <label for="teamUrl" class="col-sm-3 col-form-label">チーム紹介サイト</label>
                    <div class="col-sm-7">
                        <input type="url" name="teamUrl" value="{{ old('teamUrl') }}" id="teamUrl"
                            aria-describedby="teamUrlHelp" class="form-control @error('teamUrl') is-invalid @enderror"
                            placeholder="例：https://facebook.com/oldws/***">
                        <small id="teamUrlHelp"
                            class="form-text text-muted">facebookやinstagramなどチームを紹介などでご使用ください</small>
                        @error('teamUrl')<div class="invalid-feedback" role="alert"> {{ $message }} </div>@enderror
                    </div>
                </div>
            </div>
            <h4 class="pb-3">チーム拠点</h4>
            <div class="container mb-5">
                <div class="form-group row d-flex justify-content-around">
                    ...
                    <div class="col-sm-7">
                        ...
                        <small id="prefectureHelp" class="form-text text-muted">登録するスポーツ種別を選択してください</small>
            ...
            <div class="container mb-5">
                <div class="form-group row d-flex justify-content-around">
                    ...
                    <div class="col-sm-7">
                        ...
                        <small id="nameHelp" class="form-text text-muted">本名での登録は避けてください</small>
            ...
            <div class="form-group mt-5">
                <input type="submit" value="入力内容を確認" class="btn btn-primary btn-lg btn-block">
            </div>
        </form>
    </div>
</body>
