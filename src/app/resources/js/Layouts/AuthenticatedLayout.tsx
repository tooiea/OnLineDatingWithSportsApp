  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-white border-b border-gray-200 fixed top-0 w-full z-50 shadow">
          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                <NavLink href="" active={isActive('dashboard')}>
                  ホーム
                </NavLink>
        ...
        <div
          className={`absolute top-16 w-full bg-white shadow-md z-50 transition-opacity duration-300 ease-in-out ${showingNavigationDropdown ? 'block' : 'hidden'
            } sm:hidden`}
        >
          <div className="pt-2 pb-3 space-y-1">
            <ResponsiveNavLink href="" active={isActive('dashboard')}>
              ホーム
            </ResponsiveNavLink>
