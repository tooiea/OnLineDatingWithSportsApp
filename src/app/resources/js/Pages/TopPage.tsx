...
export default function TopPage({ isAuthenticated, routes }: Props) {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans pb-20 pt-16">
      ...
      {/* 招待・登録選択 */}
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 px-4 pb-10">
        ...
        <div className="bg-green-50 p-4 rounded-xl text-center shadow-sm">
          <h3 className="font-bold mb-2 text-green-800">自分でチームを作る方</h3>
          <a
            href={routes.temp_register_team}
            className="bg-green-600 text-white w-full inline-block py-2 rounded"
          >
            新しくチームを作る
          </a>
        </div>
